...
Showbo.Msg = {
	...
	InitMsg: function(width) {
		...
		var ifStr = '<iframe src="javascript:false" mce_src="javascript:false" style="position:absolute; visibility:inherit; top:0px;left:0px;width:100%; height:100%; z-index:-1;' + 'filter=\'progid:DXImageTransform.Microsoft.Alpha(style=0,opacity=0)\';"></iframe>',
			html = '<div class="top"><div class="right cf"><div class="title" id="dvMsgTitle"></div><div class="cloceBoxe"></div></div></div>' +
	...
	show: function(cfg) {
		...
		if(cfg.title){
			...
			document.getElementById("dvMsgBox").className="no-title";		
		}
		this.dvCT.innerHTML = '';
		if(cfg.wait) {
			...
			this.dvBottom.style.height = '0.25rem';
